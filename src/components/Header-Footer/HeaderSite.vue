      ...
      <div class="container">
        <div class="header-top">
          <nav class="nav">
            <ul class="list">
              <li class="list-item">
                <a href="#/category" class="list-link">{{$t("header.solar_panels")}}</a>
              </li>
              <li class="list-item">
          ...
          <div class="header-top-right">
            <a class="phone-number" href="tel:+998971234567">+998(78)122-12-32</a>
               <q-select borderless class="provinces-select" v-model="model" :options="options"  />
      ...
      <div class="container">
        <div class="header-bottom">
          ...
          <form class="form" method="post" autocomplete="off">
            <input class="search-input" :placeholder="$t('header.search_products')" type="text">
            <button class="search-btn">
              <img src="/images/search (2).svg" alt="">
            </button>
          </form>
          <button class="btn-login">{{$t("header.entrance_the_office")}}</button>
        </div>
      </div>
    </div>
